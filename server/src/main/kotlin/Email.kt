...
fun email(data: EmailData): String {
    fun courseLink(c: Schema.CourseId)=
        "<a href=\"${data.rootUrl}/course/${c.id}\" style=\"color: #3b3b3b\" >${
    ...
    <html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
      ...
      <body style="word-spacing:normal;background-color:#f4f4f5;">
          ...
          <img
             alt="BoilerCourses" height="auto" src="${data.rootUrl}/icon.svg" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="120"
          />
        ...
        "<li class=\"list-item\">${courseLink(it.course)}, Section ${it.section.section.trimStart { x->x=='0' }} (${formatTerm(it.term)}): <span class=\"highlight\">${it.open}</span> of <span class=\"highlight\" >${it.total}</span> seats available</li>"
          ...
          <div
             style="font-family:Inter, Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#000000;"
          >We're letting you know because you, or someone with access to your Purdue Microsoft account, has registered you for updates relating to these courses or sections. To unregister for these updates, <a href="${data.rootUrl}/notifications" >manage your notifications</a> on BoilerCourses.</div>
          ...
          >
            <tbody>
              <tr>
                ...
                >
                  <a
                     href="${data.rootUrl}/notifications" style="display:inline-block;background:#e5e7eb;color:#000000;font-family:Inter, Arial, sans-serif;font-size:18px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:6px;" target="_blank"
                  >
        ...
        <!-- Footer -->
          ...
          >Sent from BoilerCourses to ${data.email}. Don't want to receive any more emails?</div>
          ...
          ><a href="${data.unsubscribe}" style="color: #993128" >
